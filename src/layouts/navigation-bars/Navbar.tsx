...
export const Navbar = () => {
  return (
    <header className="sticky top-0 z-30 backdrop-blur-lg border-b-2 border-b-red-900">
      <nav className="flex h-18 items-center justify-between gap-10 container mx-auto">
