    ...
    <>
      <div className="flex flex-col justify-center items-center text-white py-10">
        ...
        <form method="POST" className="flex flex-col mt-10">
          ...
          <input
            className=" mt-2 border-1 border-white focus:border-5 focus:border-red-800"
            type="text"
            required
            ...
            {connectionTypes.map((item, index) => (
              <li key={index}>
                <button
                  ...
                  className="flex text-[#737373] items-center rounded-xl border-1 border-[#737373] hover:text-white "
                >
